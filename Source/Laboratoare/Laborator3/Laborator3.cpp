...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	float img_centerX = (float)window->GetResolution().x / 2;
	float img_centerY = (float)window->GetResolution().y / 2;

	angularStep += deltaTimeSeconds;
	modelMatrix *= Transform2D::Translate(img_centerX - cx, img_centerY - cy);
	modelMatrix *= Transform2D::Translate(cx, cy);
	modelMatrix *= Transform2D::Rotate(angularStep);
	modelMatrix *= Transform2D::Translate(-cx, -cy);
	...
	modelMatrix *= Transform2D::Translate(cx, cy);
	modelMatrix *= Transform2D::Rotate(angularStep);
	modelMatrix *= Transform2D::Translate(3 * cx, 3 * cy);
	modelMatrix *= Transform2D::Translate(-cx, -cy);
	...
	modelMatrix *= Transform2D::Translate(cx, cy);
	modelMatrix *= Transform2D::Rotate(angularStep);
	modelMatrix *= Transform2D::Translate(2 * cx, 2 * cy);
	modelMatrix *= Transform2D::Translate(-cx, -cy);
