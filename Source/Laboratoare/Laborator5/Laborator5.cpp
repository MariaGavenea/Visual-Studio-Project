...
void Laborator5::OnInputUpdate(float deltaTime, int mods)
{
	...
	if (window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
	{
		...
		// modificare fov la proiectia perspectiva
		...
		// modificarea latimii (tastele H, K) si inaltimii(tastele J, U) ferestrei
		// de proiectie la proiectia ortografica
